            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-10 md:py-14">
                ...
                <div className="mx-auto w-full max-w-full relative px-[10%]">
                    <div className="max-w-4xl text-start">
                        ...
                        >
                            Find Office & Administrative Jobs
                        ...
                        >
                            Discover healthcare jobs, hospitality jobs, caregiving roles, and other service careers. Whether you are hiring qualified staff or searching for your next opportunity.
                        </motion.p>
